...
namespace finaldotnetproject.Account
{
    public partial class Register : Page
    {
        ...
        {
            conn = new SqlConnection("Data Source=MUSTAFA-PC;Initial Catalog=taxi;Integrated Security=True");
            conn.Open();
           ...
           // cmd.ExecuteNonQuery();
            ...
            SqlCommand cmd1 = new SqlCommand("select * FROM [taxi].[dbo].[user] where user_email='" + email + "'", conn);
