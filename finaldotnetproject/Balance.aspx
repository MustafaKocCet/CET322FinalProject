...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      ...
      <div class="carousel-caption">
        <h3>Hemen bir araç çağır</h3>
      </div>
    </div>
    <div class="item">
      <img src="images/farm-house.jpg" alt="...">
      <div class="carousel-caption">
        <h3>Kullanımı kolay ve her an ulaşılabilir.</h3>
      </div>
    </div>
  </div>
</div>
<div class="form-horizontal">
 <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="curbal" CssClass="col-md-2 control-label">Anlık Para</asp:Label>
            <div class="col-md-10">
 ...
 <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="addbalance" CssClass="col-md-2 control-label">Para Yatır</asp:Label>
            <div class="col-md-10">
