...
namespace finaldotnetproject
{
    public partial class book : System.Web.UI.Page
    {
        ...
        {
            SqlConnection conn = new SqlConnection("Data Source=MUSTAFA-PC;Initial Catalog=taxi;Integrated Security=SSPI");
            conn.Open();
            ...
            SqlCommand cmd = new SqlCommand("insert into ride (user_id,taxi_id,distance,status,source,destination,goby) values(@a,@b,@c,@d,@e,@f,@g)", conn);
            ...
            cmd.Parameters.AddWithValue("g", DropDownList3.SelectedItem.ToString());
            cmd.ExecuteNonQuery();
            ...
            cmd2.Dispose();
            conn.Close();
            //Buraya mesaj gelecek.
            Response.Redirect("Default.aspx", true);
            //Page.ClientScript.RegisterStartupScript(this.GetType(),"Scripts","<script>alert('Aracınız Yolda!');</script>" );
        }
    }
}